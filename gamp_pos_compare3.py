...
def PoltCompare(epoch, Pos1,Pos2,Pos3,filename):
    ...
    plt.savefig(filename+'_compare3.tiff',dpi=400)
    plt.show()
    plt.close()
...
if __name__ == '__main__':
    ...
    Epoch3, Pos3,filename3,num3 = ReadPos()
    PoltCompare(Epoch1,Pos1,Pos2,Pos3,filename3)